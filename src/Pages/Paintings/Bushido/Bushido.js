        ...
        <div className="container">
            ...
            <div className="paintingpage">
                    <div className="paintingphoto">
                        ...
                        <img  src={require('../../../img/bushido2.jpg')} />
                        </div>
                            ...
                            <ModalImage
                                    ...
                                    small={require('../../../img/bushido1.jpg')}
                                    medium={require('../../../img/bushido.jpg')}
                                    alt="Bushido details"
                                    />
                            <ModalImage
                                    className="small"
                                    imageBackgroundColor="none"
                                    small={require('../../../img/bushidosmall2.jpg')}
                                    medium={require('../../../img/bushido3.jpg')}
                                    alt="Bushido"
                                    />
                            ...
                            <ModalImage
                                    className="small"
                                    imageBackgroundColor="none"
                                    small={require('../../../img/bushidosmall3.jpg')}
                                    medium={require('../../../img/bushido4.jpg')}
                                    alt="Bushido details"
                                    />
                    ...
                    <div className="paintingdescription">
                        ...
                        <FaCheck size = "40px" color="green" /> <p>Size: 70x50 cm (framed)</p>  
                        </div>
                        <div className="descriptionrow">
                        ...
                        <div class="paypal">
                                        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" >
                                            ...
                                            <input type="hidden" name="hosted_button_id" value="RTLSWRWZ6KXES"/>
